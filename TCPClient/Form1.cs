...
namespace TCPClient
{
    public partial class Form1 : System.Windows.Forms.Form
    {
        ...
        private void openDataPort()
        {
            ...
            // Start Passive Mode 
            cmdData = "PASV" + CRLF;
            szData = System.Text.Encoding.Default.GetBytes(cmdData);     //.ToCharArray()
            ...
            dataStrmRdr = new StreamReader(dataServer.GetStream(), System.Text.Encoding.GetEncoding("gbk"));     //修改1
        ...
        private void btn_conn_Click(object sender, EventArgs e)
        {
            if (btn_conn.Text == "连接")
            {
                ...
                try
                {
                    cmdStrmRdr = new StreamReader(cmdServer.GetStream(), System.Text.Encoding.GetEncoding("gbk"));   
